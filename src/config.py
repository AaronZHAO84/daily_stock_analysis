...
class Config:
    ...
    llm_batch_size: int = 3  # Same-market symbols per fast/summary-lite LLM request
    ...
    searxng_public_instances_enabled: bool = False  # Public instances are opt-in; they are rate-limited and unstable
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            llm_batch_size=parse_env_int(os.getenv('LLM_BATCH_SIZE'), 3, field_name='LLM_BATCH_SIZE', minimum=1, maximum=10),
    ...
    def _parse_report_type(cls, value: str) -> str:
        ...
        if v in ('simple', 'full', 'brief', 'summary_lite', 'summary-lite', 'fast'):
            return 'summary_lite' if v == 'summary-lite' else v
        import logging
        logging.getLogger(__name__).warning(
            f"REPORT_TYPE '{value}' invalid, fallback to 'simple' (valid: simple/full/brief/summary_lite/fast)"
        )
        return 'simple'
