...
| `REALTIME_SOURCE_PRIORITY` | Real-time quote source priority (comma-separated), default `akshare_sina,tencent`; add `tickflow` explicitly to use TickFlow realtime quotes | See .env.example | Optional |
